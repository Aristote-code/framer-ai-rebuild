// Dribbble.tsx — section converted to a real JSX component by extract-site.
...
export function Dribbble() {
  return (
    <div data-framer-component-type="SVG" data-framer-name="Dribbble" className="framer-dnafs4" aria-hidden="true" style={{ width: "79px", height: "23px", position: "relative", display: "block", flexDirection: "row", imageRendering: "pixelated", flexShrink: "0" } as CSSProperties}>
      <div className="svgContainer" style={{ width: "100%", height: "100%", position: "static", display: "block", flexDirection: "row", aspectRatio: "inherit" } as CSSProperties}>
        <svg style={{ width: "100%", height: "100%", position: "static", display: "block", flexDirection: "row", overflow: "hidden" } as CSSProperties}>
          <use href="#svg11338359397" style={{ position: "static", display: "inline", flexDirection: "row" } as CSSProperties} />
        </svg>
      </div>
    </div>
  );
