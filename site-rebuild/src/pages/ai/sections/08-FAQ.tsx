  ...
  return (
    <div className="framer-1q87a7z hv-2761" data-framer-name="FAQ" style={{ width: "1440px", height: "745.156px", padding: "120px 20px", position: "relative", display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "center", alignContent: "center", backgroundColor: "rgb(0, 0, 0)" } as CSSProperties}>
      <div className="framer-5velxz" data-framer-name="Inner" style={{ width: "1200px", height: "505.156px", maxWidth: "1200px", position: "relative", display: "flex", flexDirection: "row", justifyContent: "flex-start", alignItems: "flex-start", alignContent: "flex-start", gap: "40px" } as CSSProperties}>
        ...
        <div className="framer-wxtgop hv-2765" data-framer-name="Content" style={{ width: "773.336px", height: "505.156px", maxWidth: "100%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", alignContent: "center", overflow: "clip" } as CSSProperties}>
          <div className="framer-11hsn4a" data-border="true" data-framer-name="FAQ Item" style={{ width: "773.336px", height: "156.484px", padding: "0px 0px 30px", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "flex-start", alignContent: "flex-start", gap: "5px", overflow: "clip" } as CSSProperties}>
            <div className="framer-1ehu4a8 hvt-2767" data-framer-component-type="RichTextContainer" style={{ width: "320px", height: "24.2969px", maxWidth: "100%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "flex-start", transform: "none" } as CSSProperties}>
            ...
            <div className="ssr-variant hidden-brtj6u hv-2769" style={{ position: "static", display: "contents", flexDirection: "row" } as CSSProperties}>
              <div className="framer-1usuw4s" data-framer-component-type="RichTextContainer" style={{ width: "773.336px", height: "97.1875px", maxWidth: "100%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "flex-start", transform: "none" } as CSSProperties}>
          ...
          <div className="framer-1qwdsbl" data-border="true" data-framer-name="FAQ Item" style={{ width: "773.336px", height: "162.188px", padding: "30px 0px", position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "flex-start", alignContent: "flex-start", gap: "5px", overflow: "clip" } as CSSProperties}>
            <div className="framer-bcjf50 hv-2773" data-framer-component-type="RichTextContainer" style={{ width: "400px", height: "24.2969px", maxWidth: "100%", position: "relative", display: "flex", flexDirection: "column", justifyContent: "flex-start", transform: "none" } as CSSProperties}>
            ...
            <div className="ssr-variant hidden-brtj6u hvt-2775" style={{ position: "static", display: "contents", flexDirection: "row" } as CSSProperties}>
