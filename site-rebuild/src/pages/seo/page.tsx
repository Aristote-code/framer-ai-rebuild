...
//   3. "Agent" → src/sections/03-Agent.tsx
//   4. "Bento" → src/sections/04-Bento.tsx
//   5. "Technical SEO" → src/sections/05-TechnicalSEO.tsx
//   6. "AEO" → src/sections/06-AEO.tsx
...
import { Agent } from "./sections/03-Agent";
import { Bento } from "./sections/04-Bento";
import { TechnicalSEO } from "./sections/05-TechnicalSEO";
import { AEO } from "./sections/06-AEO";
...
export function Page() {
  return (
    <>
      <div id="main" style={{ width: "1440px", height: "11018.6px", position: "static", display: "block", flexDirection: "row", fontFamily: "sans-serif", fontSize: "12px", fontWeight: "400", textAlign: "start", color: "rgb(0, 0, 0)" } as CSSProperties}>
        <style data-framer-html-style="">
          {content.text1}
        </style>
        <div className="framer-ykIBb framer-Grv0o framer-zprce9" data-layout-template="true" data-selection="true" style={{ width: "auto", height: "11018.6px", minHeight: "100vh", padding: "64px 0px 0px", position: "relative", display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "center", alignContent: "center", backgroundColor: "rgb(0, 0, 0)", overflow: "clip", "--1moyfq9": "64px 0px 0px 0px", "--1r5dcfs": "var(--overflow-clip-fallback, clip)", "--u410qi": "var(--token-958e2cd1-b113-4aa3-9235-7a2b959c8feb, rgb(0, 0, 0))" } as CSSProperties}>
      ...
      <div id="svg-templates" style={{ position: "absolute", top: "900px", right: "1440px", zIndex: "0", inset: "900px 1440px 0px 0px", display: "block", flexDirection: "row", fontFamily: "sans-serif", fontSize: "12px", fontWeight: "400", textAlign: "start", color: "rgb(0, 0, 0)", overflow: "hidden", bottom: "0", left: "0", width: "0", height: "0", contain: "strict" } as CSSProperties} aria-hidden="true">
        ...
        {" "}
        <svg viewBox="0 0 20 20" id="svg12273361381" style={{ position: "static", display: "inline", flexDirection: "row", overflow: "hidden" } as CSSProperties}>
          <path d="M 8.021 5.43 C 7.355 5.023 6.5 5.502 6.5 6.283 L 6.5 13.717 C 6.5 14.498 7.355 14.977 8.021 14.57 L 14.104 10.853 C 14.742 10.463 14.742 9.537 14.104 9.147 Z" fill="rgba(255, 255, 255, 0.2)" strokeWidth="2" stroke="var(--token-26e3cb56-8447-4a64-9b7d-37f16a9909d4, rgb(255, 255, 255))" strokeLinecap="round" strokeLinejoin="round" style={{ position: "static", display: "inline", flexDirection: "row" } as CSSProperties} />
        </svg>
        {" "}
        <svg viewBox="0 0 12 12" id="svg10088872281" style={{ position: "static", display: "inline", flexDirection: "row", overflow: "hidden" } as CSSProperties}>
          <path d="M 1.75 2.75 C 1.75 1.645 2.645 0.75 3.75 0.75 L 4.75 0.75 C 5.302 0.75 5.75 1.198 5.75 1.75 L 5.75 4.25 C 5.75 4.802 6.198 5.25 6.75 5.25 L 9.25 5.25 C 9.802 5.25 10.25 5.698 10.25 6.25 L 10.25 9.25 C 10.25 10.355 9.355 11.25 8.25 11.25 L 3.75 11.25 C 2.645 11.25 1.75 10.355 1.75 9.25 Z" fill="rgba(0, 153, 255, 0.2)" strokeWidth="1.5" stroke={"var(--token-bd71055c-0a2c-4476-8cc9-4310acba652d, rgb(0, 153, 255)) /* {\"name\":\"Blue\"} */"} style={{ position: "static", display: "inline", flexDirection: "row" } as CSSProperties} />
          <path d="M 4.5 0.75 L 5.672 0.75 C 6.202 0.75 6.711 0.961 7.086 1.336 L 9.664 3.914 C 10.039 4.289 10.25 4.798 10.25 5.328 L 10.25 6.5" fill="transparent" strokeWidth="1.5" stroke={"var(--token-bd71055c-0a2c-4476-8cc9-4310acba652d, rgb(0, 153, 255)) /* {\"name\":\"Blue\"} */"} style={{ position: "static", display: "inline", flexDirection: "row" } as CSSProperties} />
        </svg>
        {" "}
        ...
        {" "}
        <svg viewBox="0 0 12 12" id="svg9930447034" style={{ position: "static", display: "inline", flexDirection: "row", overflow: "hidden" } as CSSProperties}>
          <path d="M 1.25 4.25 L 1.25 4.25 L 1.25 9 C 1.25 9.966 2.034 10.75 3 10.75 L 9 10.75 C 9.966 10.75 10.75 9.966 10.75 9 L 10.75 5.75 C 10.75 4.922 10.078 4.25 9.25 4.25 L 8 4.25 C 7.448 4.25 7 3.802 7 3.25 L 7 2.75 C 7 1.922 6.328 1.25 5.5 1.25 L 2.75 1.25 C 1.922 1.25 1.25 1.922 1.25 2.75 Z" fill={"var(--token-30fd6b0d-9c3a-4ed1-b7e6-4bdbb9d0fff9, rgba(255, 255, 255, 0.2)) /* {\"name\":\"Icon 100 Transparent\"} */"} strokeWidth="1.5" stroke={"var(--token-1ff51228-9678-411c-9a08-00381f0fc70b, rgb(255, 255, 255)) /* {\"name\":\"Icon 100\"} */"} style={{ position: "static", display: "inline", flexDirection: "row" } as CSSProperties} />
          <path d="M 8.5 4.25 L 1.5 4.25" fill="transparent" strokeWidth="1.5" stroke={"var(--token-1ff51228-9678-411c-9a08-00381f0fc70b, rgb(255, 255, 255)) /* {\"name\":\"Icon 100\"} */"} style={{ position: "static", display: "inline", flexDirection: "row" } as CSSProperties} />
        </svg>
        {" "}
        ...
        {" "}
        <svg id="3607753684" display="block" role="presentation" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ position: "static", display: "block", flexDirection: "row", overflow: "hidden" } as CSSProperties}>
          <path d="M 18 13.998 L 18 5.998 C 17.999 5.284 17.618 4.625 17 4.268 L 10 0.268 C 9.381 -0.089 8.619 -0.089 8 0.268 L 1 4.268 C 0.382 4.625 0.001 5.284 0 5.998 L 0 13.998 C 0.001 14.712 0.382 15.371 1 15.728 L 8 19.728 C 8.619 20.085 9.381 20.085 10 19.728 L 17 15.728 C 17.618 15.371 17.999 14.712 18 13.998 Z" fill="transparent" id="JkT2GRm49" strokeDasharray="" strokeLinecap="round" strokeLinejoin="round" strokeWidth="var(--js9iwy, 2)" stroke="var(--1m973uw, rgb(0,0,0))" transform="translate(3 2.002)" style={{ position: "static", display: "inline", flexDirection: "row", transform: "matrix(1, 0, 0, 1, 3, 2.002)", transformOrigin: "0px 0px" } as CSSProperties} />
        </svg>
        {" "}
        ...
        {" "}
        <motion.svg id="1184508750" display="block" role="presentation" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ position: "static", display: "block", flexDirection: "row", overflow: "hidden" } as CSSProperties} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, margin: "0px 0px -10% 0px", amount: 0.05 }} transition={{ duration: 0.75, ease: "linear" }}>
      ...
      <div style={{ position: "static", display: "contents", flexDirection: "row", fontFamily: "sans-serif", fontSize: "12px", fontWeight: "400", textAlign: "start", color: "rgb(0, 0, 0)" } as CSSProperties}>
        <div style={{ width: "380px", height: "143px", padding: "20px", position: "fixed", top: "757px", right: "1060px", zIndex: "10", inset: "757px 1060px 0px 0px", display: "flex", flexDirection: "row", justifyContent: "center", gap: "20px", left: "0px", bottom: "0px", boxSizing: "border-box", touchAction: "none", pointerEvents: "none" } as CSSProperties} data-cs-id="2548">
